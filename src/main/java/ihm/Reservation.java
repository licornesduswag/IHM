...
public class Reservation extends JFrame implements ActionListener{
	...
	public Reservation() {
		...
		comboBox.setBounds(175, 113, 136, 20);
		contentPane.add(comboBox);
		
		JLabel lblVoitureRserv = new JLabel("Voiture r\u00E9serv\u00E9e");
		lblVoitureRserv.setFont(new Font("Calibri", Font.PLAIN, 14));
		lblVoitureRserv.setForeground(Color.WHITE);
		lblVoitureRserv.setBounds(71, 116, 94, 14);
		contentPane.add(lblVoitureRserv);
		
		textField = new JTextField();
		textField.setBounds(175, 30, 136, 20);
		contentPane.add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setBounds(175, 71, 136, 20);
		contentPane.add(textField_1);
		textField_1.setColumns(10);
		
		JLabel lblPrenomDuClient = new JLabel("Prenom du client");
		lblPrenomDuClient.setFont(new Font("Calibri", Font.PLAIN, 14));
		lblPrenomDuClient.setForeground(Color.WHITE);
		lblPrenomDuClient.setBackground(Color.WHITE);
		lblPrenomDuClient.setHorizontalAlignment(SwingConstants.RIGHT);
		lblPrenomDuClient.setBounds(40, 33, 125, 14);
		contentPane.add(lblPrenomDuClient);
		
		JLabel lblNomDuClient = new JLabel("Nom du client");
		lblNomDuClient.setFont(new Font("Calibri", Font.PLAIN, 14));
		lblNomDuClient.setForeground(Color.WHITE);
		lblNomDuClient.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNomDuClient.setBounds(85, 74, 80, 14);
		...
		comboBox_1.setBounds(175, 152, 40, 20);
		...
		comboBox_2.setBounds(225, 152, 86, 20);
		contentPane.add(comboBox_2);
		
		comboBox_3 = new JComboBox();
		comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"2015", "2016", "2017", "2018", "2019", "2020"}));		comboBox_3.setBounds(317, 152, 67, 20);
		...
		comboBox_4.setBounds(175, 183, 40, 20);
		...
		lblNewLabel.setBounds(18, 155, 147, 14);
		contentPane.add(lblNewLabel);
		
		JLabel lblDateDeFin = new JLabel("Date de fin de location");
		lblDateDeFin.setFont(new Font("Calibri", Font.PLAIN, 14));
		lblDateDeFin.setForeground(Color.WHITE);
		lblDateDeFin.setHorizontalAlignment(SwingConstants.RIGHT);
		lblDateDeFin.setBounds(28, 186, 137, 14);
